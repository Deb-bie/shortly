  ...
  return (
    <div className="w-[100%] h-[100%] mt-32 bg-[#d3f3f3] ">
        <div className="w-[100%] flex flex-col " >
                ...
                <div className=" 4xs:w-[90%] sm:w-[70%] h-[100%] py-4 4xs:px-2 sm:px-4  4xs:text-base sm:text-lg flex flex-col gap-y-8 " >
                    {
                        ...
                        urls.map((item,id)=> (
                            <div key={id} className=" w-[100%] py-2 px-4 gap-y-4 flex 4xs:flex-col sm:flex-row justify-between items-center bg-white shadow-2xl " >
                                <span className="4xs:w-[100%] sm:w-[30%] text-base text-ellipsis overflow-hidden ">{item.origUrl}</span>

                                <a href={item.origUrl} target="_blank" rel="noreferrer" className="sm:w-[40%] 4xs:w-[100%] inline-block overflow-hidden text-ellipsis text-blue-800 underline ">{item.shortUrl}</a>
            ...
            <div className="w-[100%] h-[100%] my-24 flex flex-col justify-center items-center content-center overflow-hidden">
                <div className="w-[100%] h-[100%] gap-y-4 flex flex-col justify-between content-center items-center ">
                    <h1 className="px-4 sm:px-0 4xs:text-xl sm:text-4xl font-black flex justify-center ">Advanced Statistics</h1>
                    
                        <div className="4xs:w-[80%] sm:w-[30%] flex flex-row justify-center items-center">
                ...
                <div className="w-[100%] 4xs:px-8 sm:px-12 4xs:mt-12 sm:mt-32 gap-12 grid 4xs:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3  ">

                    <div className="w-[100%] h-[100%] px-4 pb-12 rounded-lg bg-white flex flex-col ">
                    ...
                    <div className="w-[100%] h-[100%] lg:mt-6 px-4 pb-12 rounded-lg bg-white flex flex-col ">
                        
                        <div className="w-[70px] h-[70px] -mt-[30px] rounded-[50%] flex flex-row justify-center items-center bg-[#3b3054] overflow-hidden ">
                            <img src={Detail} alt="brand" className="overflow-hidden" />
                        </div>
                        <div className="w-[100%] mt-8 4xs:text-base sm:text-3xl font-bold overflow-x-hidden ">Brand Recognition</div>
                        <p className="mt-6 4xs:text-base sm:text-xl font-semibold text-[#bfbfbf] overflow-x-hidden  ">Boost your brand recognition with each click. Generic links don't mean a thing. Branded links help instil confidence in your content.</p>
                    </div>

                    <div className="w-[100%] h-[100%] lg:mt-12 px-4 pb-12 rounded-lg bg-white shadow-2 bxl flex flex-col ">
                        
                        <div className="w-[70px] h-[70px] -mt-[30px] rounded-[50%] flex flex-row justify-center items-center bg-[#3b3054] overflow-hidden ">
                            <img src={Customizable} alt="brand" className="overflow-hidden" />
                        </div>
                        <div className="w-[100%] mt-8 4xs:text-base sm:text-3xl font-bold overflow-x-hidden ">Brand Recognition</div>
                        <p className="mt-6 4xs:text-base sm:text-xl font-semibold text-[#bfbfbf] overflow-x-hidden  ">Boost your brand recognition with each click. Generic links don't mean a thing. Branded links help instil confidence in your content.</p>
                    </div>
